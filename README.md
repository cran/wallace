...
*Wallace* is a modular platform for reproducible modeling of species niches and distributions, written in R. The application guides users through a complete analysis, from the acquisition of data to visualizing model predictions on an interactive map, thus bundling complex workflows into a single, streamlined interface. Here is a [link](http://onlinelibrary.wiley.com/doi/10.1111/2041-210X.12945/full) to the paper published in Methods in Ecology and Evolution that describes *Wallace*.
